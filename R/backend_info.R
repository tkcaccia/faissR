...
backend_info <- function() {
  ...
  data.frame(
    ...
    supported_metrics = c(
      ...
      "euclidean for direct brute force; euclidean plus normalized cosine/correlation for direct IVF/PQ, direct cuVS NN-descent, and cuVS HNSW; HNSW and CAGRA inner_product are disabled for CAGRA-derived CUDA graph routes; public CUDA NN-descent inner_product uses native CUDA candidate refinement",

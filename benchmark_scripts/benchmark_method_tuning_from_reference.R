...
apply_candidate <- function(candidate) {
  ...
  set_opt("cuda_nndescent_graph_degree", candidate$nndescent_graph_degree); set_opt("gpu_nndescent_graph_degree", candidate$nndescent_graph_degree)
  set_opt("cuda_nndescent_iters", candidate$nndescent_max_iterations); set_opt("gpu_nndescent_iters", candidate$nndescent_max_iterations)
  set_opt("cuda_nndescent_sources", candidate$nndescent_intermediate_graph_degree); set_opt("gpu_nndescent_sources", candidate$nndescent_intermediate_graph_degree)
  set_opt("cuda_nndescent_neighbors", candidate$nndescent_graph_degree); set_opt("gpu_nndescent_neighbors", candidate$nndescent_graph_degree)

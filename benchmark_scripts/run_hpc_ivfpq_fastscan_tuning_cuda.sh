...
#SBATCH --job-name="faissR_IVFPQ_FASTSCAN_CUDA"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/faissR_ivfpq_fastscan_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/faissR_ivfpq_fastscan_cuda_%j.err

set -euo pipefail


# CUDA faissR IVFPQ_FASTSCAN tuning benchmark using precomputed exact references.
#
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_IVFPQ_FASTSCAN_TUNING_CUDA_$(date +%Y%m%d_%H%M%S)}"

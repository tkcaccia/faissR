...
#SBATCH --job-name="frJ_uwot_nearest_neighbors"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_uwot_nearest_neighbors_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_uwot_nearest_neighbors_cpu12_%j.err
...
export METHOD_LABEL="uwot_nearest_neighbors"
export BACKEND="cpu"

...
#SBATCH --job-name="frT_exact_cpu12"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frT_exact_cpu12_ip_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frT_exact_cpu12_ip_%j.err

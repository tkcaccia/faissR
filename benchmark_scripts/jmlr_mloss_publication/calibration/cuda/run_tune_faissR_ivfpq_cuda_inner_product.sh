...
#SBATCH --job-name="frT_ivfpq_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frT_ivfpq_cuda_ip_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frT_ivfpq_cuda_ip_%j.err

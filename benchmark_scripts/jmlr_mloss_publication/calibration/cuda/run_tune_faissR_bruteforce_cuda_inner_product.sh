...
#SBATCH --job-name="frT_bruteforce_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frT_bruteforce_cuda_ip_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frT_bruteforce_cuda_ip_%j.err

...
#SBATCH --job-name="faissR_NND_CUDA"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/faissR_nndescent_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/faissR_nndescent_cuda_%j.err
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_NNDESCENT_TUNING_CUDA_$(date +%Y%m%d_%H%M%S)}"
